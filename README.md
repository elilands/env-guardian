...
```bash
# Using NPM
npx @elilands/env-guardian validate

# Using PNPM
pnpm dlx @elilands/env-guardian validate

# Using Yarn
yarn dlx @elilands/env-guardian validate
```

*Want to add it to your project's CI/CD pipeline? Install it as a dev dependency:*

```bash
npm install -D @elilands/env-guardian
```
...
```bash
npx @elilands/env-guardian validate --fix
```
...
```bash
npx @elilands/env-guardian scan
```
...
```bash
npx @elilands/env-guardian validate --ignore "**/legacy-app/**"
```
